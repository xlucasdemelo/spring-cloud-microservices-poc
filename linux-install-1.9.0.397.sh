...
curl -O https://download.clojure.org/install/clojure-tools-1.9.0.397.tar.gz
tar xzf clojure-tools-1.9.0.397.tar.gz
...
install -Dm644 clojure-tools/clojure-tools-1.9.0.397.jar "$clojure_lib_dir/libexec/clojure-tools-1.9.0.397.jar"
...
rm -rf clojure-tools
rm -rf clojure-tools-1.9.0.397.tar.gz
